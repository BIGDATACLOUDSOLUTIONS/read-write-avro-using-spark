...
package com.example.json.producer.pos_invoice.datagenerator;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.example.json.producer.pos_invoice.types.DeliveryAddress;
import com.example.json.producer.pos_invoice.types.LineItem;
import com.example.json.producer.pos_invoice.types.PosInvoice;
...
public class InvoiceGenerator {
    ...
    private InvoiceGenerator() {
        ...
        String DATAFILE = projectRootDir + "/src/main/resources/data/Invoice.json";
        ObjectMapper mapper;
