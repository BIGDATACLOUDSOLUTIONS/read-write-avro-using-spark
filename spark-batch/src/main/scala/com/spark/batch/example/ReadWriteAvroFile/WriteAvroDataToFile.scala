 ...
 *
 * ReadWriteAvroFile.AppOneWriter reads com.spark.stream.example.avro file and applies schema from asvc file and create a dataframe
 ...
 *
 * ReadWriteAvroFile.AppTwoWriter reads avro file and applies schema from asvc file.
